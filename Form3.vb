...
Public Class Form3
    ...
    Public Sub new_cust_quote(con)
        ...
        While rd.Read()
            If rd("Quotenumber").ToString = TODAYquote & indx Then indx += 1 : con.close() : Call new_cust_quote(con)
        End While
    ...
    Public Sub insert_customer(u_con)
        ...
        With up_com
                .Connection = u_con
                .CommandType = CommandType.Text
                .CommandText = ("INSERT INTO customer(cusname, custlastname, custaddress, custphone, custemail, custnote, cusID)
                                                   VALUES (@cusname, @custlastname, @custaddress, @custphone, @custemail, @custnote, @cusID)")
                .Parameters.AddWithValue("@cusname", D_cusname_TX.Text())
                ...
                .Parameters("@cusname").Value = D_cusname_TX.Text()
        ...
        Try
            ...
            For Each rowitem As DataGridViewRow In D_Q_DG.Rows
                ...
                With up_com
                    ...
                    .Parameters.AddWithValue("@custID", D_Q_Name.Text() & D_Q_Number_TX.Text()).ToString()
                    ...
                    .Parameters("@custID").Value = D_Q_Name.Text() & D_Q_Number_TX.Text().ToString
    ...
    Public Sub ctq_insert(con)
        ...
        With ctq_up_com
            ...
            .Parameters.AddWithValue("@ID", D_Q_Number_TX.Text() + D_cusname_TX.Text())
            ...
            .Parameters("@ID").Value = D_Q_Number_TX.Text() + D_cusname_TX.Text()
    ...
    Private Sub Save_dup_quote_BT_Click(sender As Object, e As EventArgs) Handles Save_dup_quote_BT.Click
        ...
        With checkcust
            .Connection = u_con
            .CommandText = "SELECT cusID from customer WHERE (cusID = '" & D_cusname_TX.Text & D_Cus_Phone_TX.Text & "')"
            u_con.Open()
            rd = .ExecuteReader()
        End With
        If rd.Read() = True Then u_con.Close() : Exit Sub
        u_con.Close()
